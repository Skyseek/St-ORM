...
namespace Sky\St\ORM\Config\Entity\Property;
...
require_once 'Sky/St/ORM/Config/Entity/Exception.php';

/**
 * Sky EQL Exception
 *
 * @uses       \Sky\St\ORM\Config\Entity\Exception
 * @category   Sky
 * @package    StORM
 * @subpackage Eql
 * @copyright  Copyright (c) 2011, Skyseek Technologies
 * @license    http://www.skyseek.com/License/Version1     Skyseek License, Version 1.0
 */
class Exception extends \Sky\St\ORM\Config\Entity\Exception
{
