 ...
 * @license    http://www.skyseek.com/License/Version1     Skyseek License, Version 1.0
 */
class Add extends StORM\Cli\Command 
{
	public function execute()
	{
		if(count($this->getArguments()) == 2) {
			Sky\Cli::clEcho("Add what? Use `Storm Help Add` For more ussage instructions.");
		}
	}
}
