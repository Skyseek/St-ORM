...
abstract class IdentityMap
{
	...
	protected function _setEntity($key, $entity) 
	{
		$this->_identities[$key] = $entity;
	}
	...
	protected function _hasEntity($key)
	{
		return isset($this->_identities[$key]);
	}

	protected function _remove($key)
	{
		unset($this->_identities[$key]);
	}
