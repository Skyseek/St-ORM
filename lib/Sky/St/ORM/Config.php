...
class Config
{
	...
	public function parseConfigArray(array $configArray)
	{
	...
	public function addEntity(Config\Entity $entity)
	{
		$this->_entities[] = $entity;
	}

	public function addEntityFromEntityConfigArray(array $entityConfigArray)
	{
		$newEntity = new Config\Entity();
		$newEntity->setDefaultPropertyConfig($this->getDefaultPropertyConfig());
		$newEntity->parseConfigArray($entityConfigArray);
