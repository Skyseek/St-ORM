...
abstract class Condition
{
	...
	protected $_logicalOperatorType = self::LO_AND;

	public function setLogicalOperatorType($logicalOperatorType) 
	{
		switch($logicalOperatorType) {
			case self::LO_AND:
			case self::LO_OR:
				$this->_logicalOperatorType = $logicalOperatorType;
				break;

			default:
				throw new Exception("Unknown/Unsupported Logical Operator '$logicalOperatorType'");
		}
	}

	public function getLogicalOperatorType() 
	{
		return $this->_logicalOperatorType;	
	}
}